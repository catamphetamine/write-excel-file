...
export default function generateWorksheet(data, { schema, columns, getStyle, getSharedString, customFont }) {
	if (schema) {
  ...
  return WORKSHEET_TEMPLATE
  	.replace('{data}', generateRows(data, { schema, getStyle, getSharedString, customFont }))
